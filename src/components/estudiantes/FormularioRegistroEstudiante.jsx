...
const FormularioRegistroEstudiante = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 2. Crear estudiante vinculado a la carrera
        ...
        <div className="relative p-6 max-w-xl mx-auto bg-gray-800 text-white shadow-md rounded">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-4">
              ...
              <button
                type="button"
                onClick={() => navigate("/buscar-estudiantes")}
...
export default FormularioRegistroEstudiante; 